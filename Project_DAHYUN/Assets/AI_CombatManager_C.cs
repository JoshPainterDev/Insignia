    ...
    public void BeginAI1Turn()
    {
        ...
        switch (rand)
        {
            case 0:
                ...
                break;
            case 1:
                AI1_UseAbility(AI1_ability1);
                break;
            case 2:
                AI1_UseAbility(AI1_ability2);
                break;
            case 3:
                AI1_UseAbility(AI1_ability3);
                break;
            case 4:
                AI1_UseAbility(AI1_ability4);
                break;
        }
    ...
    public void BeginAI2Turn()
    {
        ...
        switch (rand)
        {
            case 0:
                ...
                break;
            case 1:
                AI2_UseAbility(AI2_ability1);
                break;
            case 2:
                AI2_UseAbility(AI2_ability2);
                break;
            case 3:
                AI2_UseAbility(AI2_ability3);
                break;
            case 4:
                AI2_UseAbility(AI2_ability4);
                break;
        }
